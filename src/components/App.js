...
export default class App extends Component {
  ...
  render() {
    const { contacts, filter, isRender, isRenderFilter, isRenderNotific } = this.state;
    const filteredContacts = filterContacts(contacts, filter);
    return (
      <div>
        <CSSTransition  in={isRenderNotific} timeout={500} classNames={slidePhone} mountOnEnter unmountOnExit>
        <Notification />
        </CSSTransition>
        ...
        <CSSTransition  in={isRenderFilter} timeout={500} classNames={slidePhone} unmountOnExit>
